...
export class GDPRManager {
     ...
     */
    public hasConsentFor(type: keyof Omit<ConsentData, 'timestamp' | 'version' | 'language'>): boolean {
        const consent = this.getConsent();
    ...
    private enableNecessaryCookies(): void {
        ...
        try {
            ...
            const language = SecurityUtils.safeLocalStorageGet('preferred-language', 'en');
            document.cookie = `lang=${language}; path=/; max-age=31536000; SameSite=Strict`;
        } catch (error) {
            ErrorLogger.log(error as Error, 'GDPR Manager - Enable Necessary Cookies');
        }
    }
    ...
    private enableAnalyticsCookies(): void {
        try {
            ...
            ErrorLogger.log(error as Error, 'GDPR Manager - Enable Analytics Cookies');
        }
    }
    ...
    private disableAnalyticsCookies(): void {
        try {
            ...
            ErrorLogger.log(error as Error, 'GDPR Manager - Disable Analytics Cookies');
        }
    }
    ...
    private enableMarketingCookies(): void {
        try {
            ...
            ErrorLogger.log(error as Error, 'GDPR Manager - Enable Marketing Cookies');
        }
    }
    ...
    private disableMarketingCookies(): void {
        try {
            ...
            document.cookie = 'marketing_consent=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT';
        } catch (error) {
            ErrorLogger.log(error as Error, 'GDPR Manager - Disable Marketing Cookies');
        }
    }
    ...
    private enableThirdPartyCookies(): void {
        try {
            ...
            document.cookie = 'third_party_consent=true; path=/; max-age=31536000; SameSite=Lax';
        } catch (error) {
            ErrorLogger.log(error as Error, 'GDPR Manager - Enable Third Party Cookies');
        }
    }
    ...
    private disableThirdPartyCookies(): void {
        try {
            ...
            document.cookie = 'third_party_consent=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT';
        } catch (error) {
            ErrorLogger.log(error as Error, 'GDPR Manager - Disable Third Party Cookies');
        }
    }
