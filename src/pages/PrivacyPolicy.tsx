...
const PrivacyPolicy: React.FC = () => {
    ...
    const privacyContent = {
        en: {
            ...
            introduction: 'At Skin Studio, we are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, and safeguard your data in compliance with the General Data Protection Regulation (GDPR) and other applicable privacy laws.',
                ...
                <div className="privacy-content">
                    ...
                    <div className="contact-section">
                        ...
                        <div className="contact-info">
                            {content.sections[content.sections.length - 1].content.slice(1).map((item, index) => (
                                <p key={index}>{item}</p>
                            ))}
                        </div>
                    </div>
