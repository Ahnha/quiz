...
const termsContent = {
  en: {
    ...
    introduction:
      "Welcome to Skin Studio! By using our website and services, you agree to these Terms of Service. Please read them carefully.",
    sections: [
      {
      ...
      },
      {
        ...
        content: [
          ...
          <a
            key="email"
            href="mailto:info@skinstudio.app"
            style={{
              color: "var(--primary-color)",
              textDecoration: "underline",
            }}
  ...
  ro: {
    ...
    introduction:
      "Bine ai venit la Skin Studio! Prin utilizarea site-ului și serviciilor noastre, ești de acord cu acești Termeni și Condiții. Te rugăm să îi citești cu atenție.",
    sections: [
      {
