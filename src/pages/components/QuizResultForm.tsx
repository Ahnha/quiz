...
import {
  HTMLReportService,
  HTMLReportData,
} from "../../services/htmlReportService";
import {
  generatePDFContent,
  ADDITIONAL_NOTE,
} from "../../data/skinCareRecommendations";
...
const QuizResultForm: React.FC<QuizResultFormProps> = ({
  ...
  const { main: resultMain, references: resultReferences } =
      ...
      <div className="quiz-result-form-modal glass-card theme-modal">
        ...
        <div className="quiz-result-form-content modal-scrollable-content">
                        ...
                        {intro && (
                          <div
                            style={{
                              color: "var(--text-color)",
                              fontWeight: 300,
                              marginBottom: bullets.length ? 4 : 0,
                            }}
                          >
                            {intro}
                          </div>
          ...
          <div style={{ textAlign: "center", marginBottom: "24px" }}>
            {downloadMessage && (
              <div
                className={`message ${downloadMessage.includes("successfully") ? "success" : "error"}`}
                style={{
                  marginBottom: "16px",
                  fontSize: "0.9rem",
                  backgroundColor: downloadMessage.includes("successfully")
                    ? "rgba(127,176,105,0.1)"
                    : "rgba(255,107,107,0.1)",
                  color: downloadMessage.includes("successfully")
                    ? "var(--primary-color)"
                    : "#ff6b6b",
            ...
            {!downloadedSuccessfully ? (
              ...
              <div
                className="downloaded-confirmation-animation"
                style={{
              ...
              >
                <span
                  className="downloaded-checkmark"
                  style={{ fontSize: "1.5rem" }}
                >
                  📄
                </span>
                {t.quizResultForm?.successMessage ||
          ...
          >
            ...
            >
              <a
                href={ADDITIONAL_NOTE[propLanguage].tool.url}
                target="_blank"
