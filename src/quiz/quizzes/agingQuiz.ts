...
const agingQuiz: QuizDef = {
    ...
    questions: [
        // ... [your original questions go here]
        {
            ...
            options: [
                { text: { ro: "De 4+ ori pe săptămână", en: "4+ times per week" }, score: 5 },
                { text: { ro: "De 2-3 ori pe săptămână", en: "2–3 times per week" }, score: 4 },
                { text: { ro: "1 dată pe săptămână", en: "Once a week" }, score: 2 },
                { text: { ro: "Foarte rar sau deloc", en: "Rarely or never" }, score: 0 },
            ],
        },
        {
            question: {
