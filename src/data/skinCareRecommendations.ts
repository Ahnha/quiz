...
export const ADDITIONAL_NOTE: AdditionalNote = {
    ro: {
        ...
        description: "Nu toate produsele \"curate\" sunt la fel — iar ambalajele pot fi înșelătoare. Dacă vrei să înțelegi mai bine ce conține un produs cosmetic, poți analiza ingredientele cu ajutorul unui instrument gratuit:",
        tool: {
            name: "INCIdecoder",
        ...
        disclaimer: "Este o unealtă educativă, nu medicală. Dar un punct excelent de pornire pentru alegeri mai conștiente."
    },
    en: {
        title: "🔍 Check the Ingredients in Your Products",
        description: "Not all 'clean' products are created equal — and packaging can be misleading. If you'd like to better understand what a cosmetic contains, you can analyze the ingredient list using this free tool:",
        tool: {
            name: "INCIdecoder",
            url: "https://incidecoder.com/"
        },
        ...
        disclaimer: "This is an educational tool, not a medical source — but it's a great starting point for more conscious choices."
    }
};
...
export const SKIN_TYPE_RECOMMENDATIONS: Record<string, SkinCareRecommendation> = {
    'dry': {
        ro: {
            ...
            description: 'Pielea uscată are nevoie de îngrijire delicată, emolientă și bogată în ingrediente naturale. Mai jos găsești sugestii inspirate din fitoterapie și cosmetologie blândă.',
            dailyRoutine: [
            ...
            professionalAdvice: 'Dacă pielea rămâne foarte uscată și sensibilă în ciuda îngrijirii, consultă un dermatolog pentru a exclude o afecțiune precum dermatita atopică.',
            sources: [
                {
        ...
        en: {
            ...
            description: 'Dry skin needs gentle, emollient care enriched with natural ingredients. Below are suggestions inspired by herbal traditions and gentle cosmetology.',
            dailyRoutine: [
            ...
            professionalAdvice: 'If your skin remains very dry and sensitive despite proper care, consult a dermatologist to rule out conditions like atopic dermatitis.',
            sources: [
                {
                    name: 'Herbal Medicine for Skin Health – NCBI',
                    url: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8701212/'
    ...
    'normal-mixed': {
        ro: {
            ...
            description: 'Pielea normală sau mixtă are nevoie de o rutină blândă și adaptabilă. Prin îngrijire naturală, poți menține acest echilibru în mod sănătos și durabil.',
            dailyRoutine: [
            ...
            professionalAdvice: 'Dacă pielea se dezechilibrează frecvent (ex. zona T devine grasă, obrajii uscați), poate fi util să ajustezi alimentația sau să consulți un specialist în îngrijire holistică.',
            sources: [
                {
        ...
        en: {
            ...
            description: 'Normal or combination skin needs a gentle and adaptable routine. With natural care, you can maintain this balance in a healthy and sustainable way.',
            dailyRoutine: [
            ...
            professionalAdvice: 'If your skin frequently shifts (e.g., oily T-zone, dry cheeks), it may help to adjust your diet or consult a holistic skincare specialist.',
            sources: [
                {
                    name: 'Journal of Herbal Medicine – Balancing Botanicals for Mixed Skin',
                    url: 'https://www.sciencedirect.com/science/article/pii/S2210803317300742'
    ...
    'oily': {
        ro: {
            ...
            description: 'Pielea grasă are nevoie de curățare eficientă, dar blândă, și de ingrediente care să regleze sebumul fără a distruge bariera naturală. Remediile naturale pot ajuta semnificativ la menținerea clarității și prospețimii pielii.',
            dailyRoutine: [
            ...
            professionalAdvice: 'Dacă apar erupții persistente sau inflamații frecvente, poți consulta un dermatolog sau fitoterapeut pentru o abordare personalizată, combinând plante interne și externe.',
            sources: [
                {
        ...
        en: {
            ...
            description: 'Oily skin needs efficient but gentle cleansing and ingredients that regulate sebum without destroying the natural barrier. Natural remedies can significantly help maintain skin clarity and freshness.',
            dailyRoutine: [
            ...
            professionalAdvice: 'If persistent breakouts or frequent inflammation occur, you can consult a dermatologist or herbalist for a personalized approach, combining internal and external plants.',
            sources: [
                {
                    name: 'Journal of Ethnopharmacology – Medicinal plants in acne treatment',
                    url: 'https://www.sciencedirect.com/science/article/pii/S0378874111007221'
    ...
    'sensitive': {
        ro: {
            ...
            professionalAdvice: 'Dacă sensibilitatea persistă sau se agravează, consultă un dermatolog sau fitoterapeut pentru o abordare personalizată, blândă și fără iritanți.',
            sources: [
                {
        ...
        en: {
            ...
            professionalAdvice: 'If sensitivity persists or worsens, consult a dermatologist or herbal practitioner for a personalized, gentle, and irritant-free approach.',
            sources: [
                {
                    name: 'Dermatitis: Types, Causes, and Natural Remedies – NCBI',
                    url: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7603389/'
