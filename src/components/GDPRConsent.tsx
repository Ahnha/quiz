...
const GDPRConsent: React.FC = () => {
  ...
  const handleAcceptAll = () => {
    ...
    if (success) {
      ...
      ErrorLogger.log(
        new Error("GDPR Consent: Failed to save all consent"),
        "GDPR Consent",
      );
    }
  };
  ...
  const handleAcceptNecessary = () => {
    ...
    if (success) {
      setShowConsent(false);
      ErrorLogger.log(
        new Error("GDPR Consent: Necessary only"),
        "GDPR Consent",
      );
    } else {
      ErrorLogger.log(
        new Error("GDPR Consent: Failed to save necessary consent"),
        "GDPR Consent",
      );
    }
  };
  ...
  const handleRejectAll = () => {
    ...
    if (success) {
      ...
      ErrorLogger.log(
        new Error("GDPR Consent: Failed to save rejection"),
        "GDPR Consent",
      );
    }
  };
  ...
  const handleSavePreferences = () => {
    ...
    if (success) {
      setShowConsent(false);
      ErrorLogger.log(
        new Error("GDPR Consent: Custom preferences saved"),
        "GDPR Consent",
      );
    } else {
      ErrorLogger.log(
        new Error("GDPR Consent: Failed to save custom preferences"),
        "GDPR Consent",
      );
    }
  };
                ...
                <div className="preference-header">
                  <label className="preference-label">
                    ...
                    <div className="preference-info">
                      ...
                      <span className="always-active">
                        {t.gdpr?.necessary?.alwaysActive}
                      </span>
                    </div>
                  </label>
                </div>
