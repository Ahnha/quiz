...
const SecureInput: React.FC<SecureInputProps> = ({
  ...
  const validateInput = useCallback(
      ...
      switch (type) {
        ...
        default:
          ...
          if (
            ...
            sanitizedValue.length < validation.minLength
          ) {
            isValid = false;
          ...
          if (
            ...
            sanitizedValue.length > validation.maxLength
          ) {
            isValid = false;
          ...
          if (
            ...
            !validation.customValidator(sanitizedValue)
          ) {
            isValid = false;
    ...
    [type, validation, required, onValidationError, isTouched],
  ); // Dependencies array (like @Cacheable key)
